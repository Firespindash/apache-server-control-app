...
"border: none;")
        ...
        def showOutput(out):
            ...
            if str(out) == '':
                out = "Something went wrong, to see what is it, please run in terminal.\n"
            else:
                print(out)
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_enable.setText(_translate("MainWindow", "Enable"))
        self.label_disable.setText(_translate("MainWindow", "Disable"))
